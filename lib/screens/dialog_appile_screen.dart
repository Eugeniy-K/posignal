...
import 'package:posignal/screens/home_page.dart';
import 'package:posignal/constants.dart';

class DialogAppileScreen extends StatefulWidget {

  final String title;
  final String number;
  final String region;

  DialogAppileScreen({this.title, this.number, this.region});

  @override
  _DialogAppileScreenState createState() => _DialogAppileScreenState();
}

class _DialogAppileScreenState extends State<DialogAppileScreen> {
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Expanded(
                    child: Container(                                               //контейнер поля ввода
                      // width: 100,
                      // height: 70,
                  ...
                  SizedBox(width: 5,),
                  GestureDetector(                                                  //кнопка отправить сообщение
                    onTap: () {},
